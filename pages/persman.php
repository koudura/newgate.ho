    ...
    <div class="grid">
        ...
        <div class = "stuff text-center">
            <div class = "middlegrid">   
                ...
                <div class = "card">
                    <h2>Allergies</h2>
                    <a href="addallergies.php">Add Allergy</a>
                    <?php if($allergies){ ?>
                    <table>
                        <thead>
                            <th>Description</th>
                        ...
                        <?php foreach($allergies as $allergy){
                            ...
                            <tr>
                            <td>$allergy->desc</td>
                            <td><a href="editallergies.php?ID=$allergy->ID">EDIT</a></td>
                            </tr>
_END;
                ...
                <div class = "card">
                    ...
                    <table>
                        ...
                        <?php foreach($sessions as $session){
                            $last = ($sessions[count($sessions)-1] == $session)? '<a href="editsessions.php?ID=$session->ID">EDIT</a>':'<a href="viewsessions.php?ID=$session->ID">VIEW</a>';
                            echo <<<_END
                            <tr>
