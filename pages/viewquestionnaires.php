    ...
    <div class="stuff">
        <table class="genTab">
            ...
            <?php foreach ($quests as $quest) {
                if (!$quest->filledByUser($conn, $current_user->id)){
                    echo <<<_END
                    <tr>
                        <td> $quest->ID</td>
                        <td> $quest->title</td>
                        <td> <a href="fillquestionnaires.php?id=$quest->ID">FILL</a></td>
                    </tr>
_END;
                    }else {
                        echo <<<_END
                    <tr>
                        <td> $quest->ID</td>
                        <td> $quest->title</td>
                        <td> <a href="readquestionnaires.php?id=$quest->ID">READ</a></td>
                    </tr>
_END;
                    } 
                }
